...
#define vInterruptC0_On()																		\
{																								\
	USARTC0.CTRLA |= USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc;		\
}

#define vInterruptC0_Off()																		\
{																								\
	USARTC0.CTRLA &= ~(USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc);	\
}
...
#define vInterruptC1_On()																		\
{																								\
	USARTC1.CTRLA |= USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc;		\
}

#define vInterruptC1_Off()																		\
{																								\
	USARTC1.CTRLA &= ~(USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc);	\
}

/*----------- USARTD:0---------------------------------------*/
#define vInterruptD0_On()																		\
{																								\
	USARTD0.CTRLA |= USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc;		\
}

#define vInterruptD0_Off()																		\
{																								\
	USARTD0.CTRLA &= ~(USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc);	\
}
/*----------- USARTD:1---------------------------------------*/
#define vInterruptD1_On()																		\
{																								\
	USARTD1.CTRLA |= USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc;		\
}

#define vInterruptD1_Off()																		\
{																								\
	USARTD1.CTRLA &= ~(USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc);	\
}
/*----------- USARTE:0---------------------------------------*/
#define vInterruptE0_On()																		\
{																								\
	USARTE0.CTRLA |= USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc;		\
}

#define vInterruptE0_Off()																		\
{																								\
	USARTE0.CTRLA &= ~(USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc);	\
}
/*----------- USARTE:1---------------------------------------*/
#define vInterruptE1_On()																		\
{																								\
	USARTE1.CTRLA |= USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc;		\
}

#define vInterruptE1_Off()																		\
{																								\
	USARTE1.CTRLA &= ~(USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc);	\
}
/*----------- USARTF:0---------------------------------------*/
#define vInterruptF0_On()																		\
{																								\
	USARTF0.CTRLA |= USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc;		\
}

#define vInterruptF0_Off()																		\
{																								\
	USARTF0.CTRLA &= ~(USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc);	\
}
/*----------- USARTF:1---------------------------------------*/
#define vInterruptF1_On()																		\
{																								\
	USARTF1.CTRLA |= USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc;		\
}

#define vInterruptF1_Off()																		\
{																								\
	USARTF1.CTRLA &= ~(USART_RXCINTLVL_HI_gc | USART_TXCINTLVL_HI_gc USART_DREINTLVL_HI_gc);	\
}
#else
...
/* Create a handle for the serial port, USARTC0. */
/* This variable is special, as it is used in the interrupt */
xComPortHandle xSerialC0Port;

/* Create a handle for the serial port, USARTC1. */
/* This variable is special, as it is used in the interrupt */
xComPortHandle xSerialC1Port;

/* Create a handle for the serial port, USARTD0. */
/* This variable is special, as it is used in the interrupt */
xComPortHandle xSerialD0Port;

/* Create a handle for the serial port, USARTD1. */
/* This variable is special, as it is used in the interrupt */
xComPortHandle xSerialD1Port;

/* Create a handle for the serial port, USARTE0. */
/* This variable is special, as it is used in the interrupt */
xComPortHandle xSerialE0Port;

/* Create a handle for the serial port, USARTE1. */
/* This variable is special, as it is used in the interrupt */
xComPortHandle xSerialE1Port;

/* Create a handle for the serial port, USARTF0. */
/* This variable is special, as it is used in the interrupt */
xComPortHandle xSerialF0Port;

/* Create a handle for the serial port, USARTF1. */
/* This variable is special, as it is used in the interrupt */
xComPortHandle xSerialF1Port;
/*-----------------------------------------------------------------*/
...
void xSerialFlush( const xComPortHandlePtr pxPort )
{
	...
	ringBuffer_Flush( (ringBuffer_t*) &(pxPort->xRxedChars) );
}
...
UBaseType_t xSerialPutChar( const xComPortHandlePtr pxPort, const UBaseType_t cOutChar )
{
	...
	else
	{
		...
		_delay_us(32); // delay for about one character (maximum _delay_loop_1() delay is 34 us at 22MHz)
		_delay_us(32);
		_delay_us(32);
